        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground">
              Have questions about our products? We're here to help you
              automate.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="p-8 md:p-12 rounded-[40px] bg-primary text-primary-foreground space-y-8 shadow-2xl relative overflow-hidden">
              ...
              <p className="opacity-90">
                The fastest way to reach us is through WhatsApp. Click the
                button below to start a chat with our support team.
              </p>
