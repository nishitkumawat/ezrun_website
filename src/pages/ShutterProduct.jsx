...
import { Smartphone, ShieldCheck, Wifi, Key, RotateCcw, MessageSquare } from 'lucide-react';

const ShutterProduct = () => {
  const whatsappMsg = encodeURIComponent("I am interested in the Advanced Shutter Controller. Please provide more details.");
  ...
  return (
    <div className="flex flex-col py-20 gap-20">
      ...
      <section className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            The ultimate solution for industrial and residential rolling shutters. 
            Experience the perfect blend of physical security and mobile convenience.
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-card border">
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-primary"><Wifi className="w-5 h-5" /> Connectivity</h3>
            ...
            <div className="p-8 rounded-2xl bg-card border">
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-primary"><Key className="w-5 h-5" /> Keypad Controls</h3>
              <ul className="space-y-3 text-muted-foreground">
                <li>• <b>A:</b> Open Shutter</li>
                <li>• <b>B:</b> Stop</li>
                <li>• <b>C:</b> Close Shutter</li>
                <li>• <b>#:</b> Start Password Entry</li>
                <li>• <b>*:</b> Confirm Entry</li>
              </ul>
            </div>
            <div className="p-8 rounded-2xl bg-card border">
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-primary"><RotateCcw className="w-5 h-5" /> Maintenance</h3>
              <ul className="space-y-3 text-muted-foreground">
      ...
      <section className="container mx-auto px-4 py-10">
        <h2 className="text-3xl font-bold mb-16 text-center">Why Choose EzRun?</h2>
      ...
      <section className="container mx-auto px-4 py-20 animate-fade-in">
        <div className="bg-primary/95 backdrop-blur-sm rounded-[40px] p-12 text-center text-white space-y-6 shadow-2xl border border-white/10">
          <h2 className="text-4xl md:text-5xl font-bold">Secure your industrial premises today</h2>
          <p className="text-lg opacity-90 max-w-xl mx-auto">
            Join hundreds of industrial and residential users who trust EzRun for their rolling shutter security.
          </p>
