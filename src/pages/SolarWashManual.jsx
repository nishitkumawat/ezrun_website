    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      >
        ...
        <div className="border-b-2 border-primary pb-6 mb-8 flex justify-between items-end">
          <div>
            <h2 className="text-xl font-bold text-primary m-0 uppercase tracking-wider">
              EzRun Automation
            </h2>
            <p className="text-sm text-gray-600 m-0">
              Smart Solutions for Solar Efficiency
            </p>
          </div>
        ...
        <div className="prose prose-lg max-w-none text-black">
          ...
          <section className="mb-12">
            ...
            <h3 className="text-xl font-medium mb-2 text-black">
              Product Name: EzRun Smart Solar Panel Wash Controller
            </h3>
            <p className="mb-4 text-black">
              <strong>Application:</strong> Automatic solar panel sprinkler
              cleaning
            </p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-primary">
              2. How the EzRun Controller Works
            </h2>
            <p className="mb-4 text-black">
              The controller connects to a water pump used for solar panel
              cleaning. Cleaning can be controlled using:
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-2 text-black">
            ...
            <p className="text-black font-medium">
              Once configured, the system works fully automatically, even
              without internet.
            </p>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6 border border-gray-100">
              ...
              <p className="mb-3 text-black">
                Best for fixed and regular cleaning routines.
              </p>
              ...
              <p className="mb-2 text-black italic">
                Automatically repeats every week. No daily setup required.
              </p>
              <p className="font-medium text-black">
                Recommended for:{" "}
                <span className="font-normal">
                  Residential rooftops & small solar plants
                </span>
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-6 border border-gray-100">
              ...
              <p className="mb-3 text-black">
                Designed for dusty or high-pollution areas.
              </p>
              <p className="mb-3 text-black">
                Cleaning runs automatically at fixed intervals:
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-1 text-black">
              ...
              <p className="mb-2 text-black italic">
                Useful where dust settles quickly.
              </p>
              <p className="font-medium text-black">
                Recommended for:{" "}
                <span className="font-normal">
                  Industrial zones, highways, construction areas
                </span>
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="mb-3 text-black">
                Used for emergency or extra cleaning.
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-1 text-black">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-primary">
              4. Supported Pumps & Load Limits
            </h2>

            <div className="mb-6">
              <h3 className="text-xl font-medium mb-3 text-green-700">
                ✅ Recommended Pumps (Best for Solar)
              </h3>
              <h4 className="font-semibold mb-2 text-black">
                DC Pumps (Highly Recommended)
              </h4>
              <ul className="list-disc pl-6 mb-4 space-y-1 text-black">
            ...
            <div className="mb-6">
              ...
              <p className="mb-2 text-black">
                Allowed only for small, low-power pumps:
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-1 text-black">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-primary">
              5. Wi-Fi Setup (AP Mode Configuration)
            </h2>
            <h3 className="text-xl font-medium mb-3 text-black">
              First-Time Setup
            </h3>
            ...
            <ol className="list-decimal pl-6 mb-6 space-y-2 text-black">
              <li>
                Open browser and enter <strong>192.168.4.1</strong>
              </li>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-primary">
              6. Reset Button (Pin-Hole Reset)
            </h2>
            <p className="mb-4 text-black">
              Reset button is inside a small hole on the enclosure.
            </p>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-primary">
              7. Bypass Switch (Manual Control)
            </h2>
            <p className="mb-4 text-black italic">
              Physical switch provided on the unit. Allows direct pump
              operation.
            </p>

            <p className="mb-4 text-black">
              Works even if Wi-Fi is not available or controller is offline.
            </p>

            <ul className="list-disc pl-6 mb-4 space-y-1 text-black">
              <li>
                <strong>Bypass ON:</strong> Pump runs manually (ignores logic)
              </li>
              <li>
                <strong>Bypass OFF:</strong> Pump controlled by controller &
                schedules
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 text-primary">
              8. Suitable Installation Conditions
            </h2>
            <ul className="list-disc pl-6 space-y-1 text-black">
        ...
        <div className="mt-12 pt-8 border-t-2 border-gray-100 flex flex-col md:flex-row justify-between items-start md:items-center text-sm text-gray-500 gap-4">
          ...
          <div className="flex flex-col md:items-end">
            <p className="m-0 font-medium">Support: work@ezrun.in</p>
            <p className="m-0 font-medium">Website: www.ezrun.in</p>
            <p className="m-0 text-xs mt-1">
              © {new Date().getFullYear()} EzRun Automation. All rights
              reserved.
            </p>
          </div>
        </div>
