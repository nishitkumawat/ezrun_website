...
import { Smartphone, Zap, Wifi, Clock, Droplets, BatteryCharging, Calendar, Watch, PlayCircle, Layout } from 'lucide-react';

const SolarWashController = () => {
  const whatsappMsg = encodeURIComponent("I am interested in the Smart Solar Panel Wash Controller. Please provide more details.");
  const whatsappUrl = `https://wa.me/919974776076?text=${whatsappMsg}`;
    ...
    <div className="flex flex-col py-20 gap-20">
      ...
      <section className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
            Smart <span className="text-primary">Solar Panel Wash</span> Controller
          </h1>
          <p className="text-xl text-muted-foreground leading-relaxed">
            The Smart Solar Panel Wash Controller automatically cleans your solar panels at the right time without manual effort. 
            It helps keep panels clean, improves electricity generation, and reduces the need for regular human cleaning.
          </p>
      ...
      <section className="bg-muted/30 py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center">Cleaning Options</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-card border">
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-primary"><Calendar className="w-5 h-5" /> Scheduled Cleaning</h3>
              <p className="mb-4 text-sm text-muted-foreground">Ideal for regular, fixed cleaning routines.</p>
            ...
            <div className="p-8 rounded-2xl bg-card border">
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-primary"><Watch className="w-5 h-5" /> Interval Cleaning</h3>
              <p className="mb-4 text-sm text-muted-foreground">Best for dusty or industrial areas.</p>
              <ul className="space-y-3 text-muted-foreground">
            ...
            <div className="p-8 rounded-2xl bg-card border">
              <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-primary"><PlayCircle className="w-5 h-5" /> Manual Cleaning</h3>
              <p className="mb-4 text-sm text-muted-foreground">Useful for emergency or extra cleaning.</p>
              <ul className="space-y-3 text-muted-foreground">
      ...
      <section className="container mx-auto px-4 py-10">
        <h2 className="text-3xl font-bold mb-16 text-center">Why You Need This?</h2>
      ...
      <section className="container mx-auto px-4 py-20 animate-fade-in">
        <div className="bg-primary/95 backdrop-blur-sm rounded-[40px] p-12 text-center text-white space-y-6 shadow-2xl border border-white/10">
          <h2 className="text-4xl md:text-5xl font-bold">Bulk Orders & Custom Needs</h2>
          <p className="text-lg opacity-90 max-w-xl mx-auto">
            Special pricing for bulk orders. Suitable for large solar installations with custom cleaning schedules available.
          </p>
