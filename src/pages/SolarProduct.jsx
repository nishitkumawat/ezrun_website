  ...
  return (
    <div className="flex flex-col py-20 gap-20">
      ...
      <section className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
            AI Based <span className="text-primary">Solar</span> Monitoring & Washing
          </h1>
          <p className="text-xl text-muted-foreground leading-relaxed">
            This is our advanced solar monitoring system which helps you track all the information about your solar panels.
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-primary font-medium">(Negotiable for bulk orders)</p>
          </div>
        </div>
      ...
      <section className="bg-muted/30 py-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground">Advanced dust detection algorithms coupled with precision cleaning hardware.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="p-8 rounded-3xl bg-card border shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                The system automatically detects dust accumulation on your solar panels. 
                When detected, it will automatically turn on your cleaning mechanism. 
                If you don't have a cleaning mechanism installed, it will send an instant alert to your device 
                so you can clean the solar panels yourself and maintain peak efficiency.
              </p>
            </div>
            <div className="p-8 rounded-3xl bg-card border shadow-sm hover:shadow-md transition-shadow">
              <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-6 text-primary">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                Track production metrics, voltage fluctuations, and maintenance history. 
                Our AI analyzes performance data to provide deep insights into your energy generation 
                and system health, accessible from anywhere via our unified app.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-10">
        <h2 className="text-3xl font-bold mb-16 text-center underline decoration-primary decoration-4 underline-offset-8">Setup & Connectivity</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {modes.map((mode, i) => (
            <div key={i} className="flex gap-6 p-8 rounded-2xl border bg-card/50 hover:bg-card transition-colors duration-300">
      ...
      <section className="container mx-auto px-4 py-20 animate-fade-in">
        <div className="bg-primary/95 backdrop-blur-sm rounded-[40px] p-12 text-center text-white space-y-6 shadow-2xl border border-white/10">
          <h2 className="text-4xl md:text-5xl font-bold">Ready to boost your solar output?</h2>
          <p className="text-lg opacity-90 max-w-xl mx-auto">
            Join hundreds of happy customers using EzRun to keep their solar panels clean and efficient.
          </p>
