...
const BentoCard = ({
  ...
  <Link
    ...
    className={cn(
      ...
      "transform-gpu border border-gray-100",
      className,
    )}
  >
    <div>{background}</div>
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10 max-w-[65%]">
    ...
    >
        <InteractiveHoverButton text={cta} className="h-10 w-44 pointer-events-none" />
    </div>
