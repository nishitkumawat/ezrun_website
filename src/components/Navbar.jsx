          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-40">
                ...
                <DropdownMenuItem
                  onClick={() => setShowWindowsDialog(true)}
                  className="cursor-pointer gap-2"
                >
      ...
      <Dialog open={showIosDialog} onOpenChange={setShowIosDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              We are currently working on our iOS application. Stay tuned for
              updates!
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={showWindowsDialog} onOpenChange={setShowWindowsDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Windows applications are custom-built based on user requirements.
              If you need a desktop solution, please contact us.
            </DialogDescription>
          </DialogHeader>
          <div className="flex flex-col gap-4">
            ...
            <Button
              variant="outline"
              onClick={() => setShowWindowsDialog(false)}
            >
              Close
            </Button>
          </div>
