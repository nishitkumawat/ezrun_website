      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Leading the way in smart automation solutions for homes and industries. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/product/shutter" className="text-sm text-muted-foreground hover:text-primary transition-colors">Shutter Controller</Link></li>
              <li><Link to="/product/solar" className="text-sm text-muted-foreground hover:text-primary transition-colors">Solar Monitoring</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>+91 9974776076</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                <Mail className="w-4 h-4 text-primary shrink-0" />
                <span>contact@ezrun.in</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Nishit Kumawat. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground">
